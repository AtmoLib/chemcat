...
project = u'chemcat'
copyright = u'2022, Patricio Cubillos and Jasmina Blecic'
...
version = re.search(r'([\.\d]*)', chemcat.__version__).group(0)
...
# of the sidebar.
#html_logo = 'figures/chemcat_logo.png'
...
latex_documents = [(
    master_doc,
    'chemcat.tex',
    u'chemcat Documentation',
    u'Patricio Cubillos and Jasmina Blecic',
    'howto',
    ),
]
