...
Please cite this paper if you found ``chemcat`` useful for your research:
  `Cubillos, Blecic, et al. (2026): Pyrat Bay 2.0: an Upgraded Framework for Exoplanet Atmosphere Modeling in the JWST Era. <http://ui.adsabs.harvard.edu/abs/2026mnras.000....0C>`_
